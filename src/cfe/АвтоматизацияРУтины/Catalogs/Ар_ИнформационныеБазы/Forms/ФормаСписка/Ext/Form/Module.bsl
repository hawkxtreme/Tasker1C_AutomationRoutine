...
&НаКлиенте
Процедура ОбновитьГиперссылкуПутьКБазеНаКлиенте(База)
	
	Если База <> Неопределено Тогда
		
		Данные 					= Ар_ИнформационныеБазыВызовСервера.ПолучитьДанныеФормированияКоманды(База, "");
...
Процедура СписокПриАктивизацииСтроки(Элемент)
	...
	ОбновитьГиперссылкуПутьКБазеНаКлиенте(ТекущаяБаза);
