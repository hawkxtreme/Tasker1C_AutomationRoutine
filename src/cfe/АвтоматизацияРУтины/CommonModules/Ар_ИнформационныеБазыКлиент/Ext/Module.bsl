...
Процедура СеансыИнформационнойБазы(Форма, ИнформационнаяБаза, Параметры = Неопределено) Экспорт
	...
	Если Не Параметры.Отказ Тогда
		...
		ОткрытьФорму("Справочник.Ар_ИнформационныеБазы.Форма.Кластер_Сеансы", ПараметрыОткрытия, Форма,,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
		
	КонецЕсли;
	
КонецПроцедуры

Процедура УдалитьСеансыИнформационнойБазы(Форма, ИнформационнаяБаза, Параметры = Неопределено) Экспорт
	...
	Если Не Параметры.Отказ Тогда
		...
		Ар_ИнформационныеБазыВызовСервера.УдалитьСеансыИнформационнойБазы(Параметры.ПараметрыКластера, Параметры.ПараметрыИБ);
...
Процедура СоединенияСИнформационнойБазой(Форма, ИнформационнаяБаза, Параметры = Неопределено) Экспорт
	...
	Если Не Параметры.Отказ Тогда
		...
		ОткрытьФорму("Справочник.Ар_ИнформационныеБазы.Форма.Кластер_Соединения", ПараметрыОткрытия, Форма,,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
		
	КонецЕсли;
	
КонецПроцедуры

Процедура РазорватьСоединенияСИнформационнойБазой(Форма, ИнформационнаяБаза, Параметры = Неопределено) Экспорт
	...
	Если Не Параметры.Отказ Тогда
		...
		Ар_ИнформационныеБазыВызовСервера.РазорватьСоединенияСИнформационнойБазой(Параметры.ПараметрыКластера, Параметры.ПараметрыИБ);
