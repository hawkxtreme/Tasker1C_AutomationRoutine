...
Процедура ВыгрузитьКонфигурацииНаКлиенте(Данные, Отказ)
	...
	ДанныеКонфигураций = ЗначенияРеквизитовОбъектовНаСервереБезКонтекста(Данные.Конфигурации, "ПолучатьИзмененияИзХранилища, Приложение1с, КаталогХранилища, ПользовательХранилища, ПарольПользователяВХранилище");
	
	Для Каждого Конфигурация Из Данные.Конфигурации Цикл
		
		ОтказКонфигурация	= Ложь;
		ДанныеКонфигурации 	= ДанныеКонфигураций[Конфигурация];
		...
		Если Не Отказ Тогда
			...
			ДанныеКоманды.Вставить("Приложение1с", ДанныеКонфигурации.Приложение1с);
			ДанныеКоманды.Вставить("Путь", Данные.Путь);
			ДанныеКоманды.Вставить("ПутьВременнойБазы", Ар_РаботаСКоманднойСтрокойКлиентСервер.ПолучитьПутьКВременнойБазе(Данные.Путь));
			ДанныеКоманды.Вставить("КаталогХранилища", ДанныеКонфигурации.КаталогХранилища);
			ДанныеКоманды.Вставить("ПользовательХранилища", ДанныеКонфигурации.ПользовательХранилища);
			ДанныеКоманды.Вставить("ПарольПользователяВХранилище", ДанныеКонфигурации.ПарольПользователяВХранилище);
			ДанныеКоманды.Вставить("ПутьФайла", ПутьФайла);
